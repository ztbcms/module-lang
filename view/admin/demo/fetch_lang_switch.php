        ...
        new Vue({
            ...
            methods: {
                ...
                getDictionaryList: function(callback){
                    ...
                    $.ajax({
                        type: "GET",
                        url: '{:url("/lang/api/allDictionary")}?lang=' + lang,
                        dataType: "json",
                ...
                getLangList: function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: '{:url("/lang/api/lang")}',
                        headers: {
                            'Lang': that.current_lang
                        },
                        dataType: "json",
                        success: function (res) {
                            that.langList = res.data.items
                ...
                clickRequestAdmin: function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: '{:url("/lang/admin.demo/doRequestAdmin")}',
                        data: {
                            'lang': that.current_lang
                        },
                        dataType: "json",
            ...
            watch: {
                current_lang: function(newValue){
                    var that = this
                    this.$message.success('语言切换为==>' + this.current_lang)
